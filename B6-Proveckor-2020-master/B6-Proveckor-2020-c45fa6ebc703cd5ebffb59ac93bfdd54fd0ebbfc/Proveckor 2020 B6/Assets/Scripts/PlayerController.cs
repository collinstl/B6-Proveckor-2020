...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(Input.GetKeyDown(movementKeys[2]) && player2.localScale.x < 0) { player2.localScale = new Vector2(-player2Scale.x, player2Scale.y); }
        else if(Input.GetKeyDown(movementKeys[3]) && player2.localScale.x > 0) { player2.localScale = new Vector2(player2Scale.x, player2Scale.y); }
